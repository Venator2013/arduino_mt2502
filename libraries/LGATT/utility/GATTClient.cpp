...
static VMUINT32 gatt_client_get_free_index(void)
{
    ...
    {
        if (GATT_CLIENT_BD_ADDR_LIST[idx].bd_addr.addr[0] == 0 && GATT_CLIENT_BD_ADDR_LIST[idx].bd_addr.addr[1] == 0 && GATT_CLIENT_BD_ADDR_LIST[idx].bd_addr.addr[2] == 0 && GATT_CLIENT_BD_ADDR_LIST[idx].bd_addr.addr[3] == 0 && GATT_CLIENT_BD_ADDR_LIST[idx].bd_addr.addr[4] == 0 && GATT_CLIENT_BD_ADDR_LIST[idx].bd_addr.addr[5] == 0)
        {
            return idx;
        }
    }
...
void gatt_client_vmt_scan_result_callback(VM_BT_GATT_CONTEXT_HANDLE reg_ctx, vm_bt_gatt_address_t *bd_addr, VMINT32 rssi, VMUINT8 eir_len, VMUINT8 *eir)
{
    ...
    if (client->_cntx.reg_ctx == reg_ctx)
    {
        ...
        for (i = 0; i < idx; i++)
        {
            if (GATT_CLIENT_BD_ADDR_LIST[i].bd_addr.addr[0] == bd_addr->data[0] && GATT_CLIENT_BD_ADDR_LIST[i].bd_addr.addr[1] == bd_addr->data[1] && GATT_CLIENT_BD_ADDR_LIST[i].bd_addr.addr[2] == bd_addr->data[2] && GATT_CLIENT_BD_ADDR_LIST[i].bd_addr.addr[3] == bd_addr->data[3] && GATT_CLIENT_BD_ADDR_LIST[i].bd_addr.addr[4] == bd_addr->data[4] && GATT_CLIENT_BD_ADDR_LIST[i].bd_addr.addr[5] == bd_addr->data[5])
            {
...
void gatt_client_get_descriptor_callback(vm_bt_gatt_connection_t *conn, VMBOOL status, vm_bt_gatt_client_descriptor_t *descr)
{
    ...
    if (status == VM_OS_STATUS_SUCCESS)
    {
        ...
        APP_LOG("[LGATT]descr [0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x]",
                descr->descriptor_uuid->uuid.uuid[15],
                descr->descriptor_uuid->uuid.uuid[14],
                descr->descriptor_uuid->uuid.uuid[13],
                descr->descriptor_uuid->uuid.uuid[12],
                descr->descriptor_uuid->uuid.uuid[11],
                descr->descriptor_uuid->uuid.uuid[10],
                descr->descriptor_uuid->uuid.uuid[9],
                descr->descriptor_uuid->uuid.uuid[8],
                descr->descriptor_uuid->uuid.uuid[7],
                descr->descriptor_uuid->uuid.uuid[6],
                descr->descriptor_uuid->uuid.uuid[5],
                descr->descriptor_uuid->uuid.uuid[4],
                descr->descriptor_uuid->uuid.uuid[3],
                descr->descriptor_uuid->uuid.uuid[2],
                descr->descriptor_uuid->uuid.uuid[1],
                descr->descriptor_uuid->uuid.uuid[0]);
    }
    else
    {
